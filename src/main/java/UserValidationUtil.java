 ...
 * <p>
 * All validation methods throw IllegalArgumentException and must be handled by the calling method.
 * <p>
 * Validation rules:
...
public class UserValidationUtil {
    ...
    public static String validatePassword(String password) {
        if (!PASSWORD_PATTERN.matcher(password).matches()) {
            throw new IllegalArgumentException("Insufficient password complexity");
        }
